...
N_OX77    "do.bat.alarm"
N_OX78    "o.debug"
N_OX81    "eo.gp.s.opened[1]"
N_OX82    "eo.gp.c.opened[1]"
N_OX83    "eo.gp.c.closed[1]"
N_OX84    "eo.gp.error[1]"
N_OX85    "eo.gp.sensor[1]"
N_OX89    "eo.gp.s.opened[2]"
N_OX90    "eo.gp.c.opened[2]"
N_OX91    "eo.gp.c.closed[2]"
N_OX92    "eo.gp.error[2]"
N_OX93    "eo.gp.sensor[2]"
...
N_WX71    "di.ext.slow"
N_WX81    "ei.gp.open[1]"
N_WX82    "ei.gp.close[1]"
N_WX84    "ei.check.gp[1]"
N_WX89    "ei.gp.open[2]"
N_WX90    "ei.gp.close[2]"
N_WX92    "ei.check.gp[2]"
...
N_WX369    "d.g2.jaws.body[0]"
N_WX377    "d.cnc1.jaws.ful[0]"
N_WX385    "d.cnc1.jaws.bod[0]"
N_WX393    "d.cnc2.jaws.ful[0]"
N_WX401    "d.cnc2.jaws.bod[0]"
...
N_WX566    "d.rdy.pick[1]"
N_WX567    "d.rdy.pick[2]"
N_WX568    "d.cnc.first"
N_WX569    "d.gp.first"
N_WX570    "d.i.change"
N_WX571    "d.e.change"
N_WX577    "d.gp.chg.i[1]"
N_WX578    "d.gp.chg.i[2]"
N_WX579    "d.gp.chg.e[1,1]"
N_WX580    "d.gp.chg.e[1,2]"
N_WX581    "d.gp.chg.e[2,1]"
N_WX582    "d.gp.chg.e[2,2]"
...
.PROGRAM cnc.pick (.tool.no,.chuck.no)
  ...
  IF SIG (eo.gp.error[.tool.no]) THEN
...
.PROGRAM gripper.is.open (.tool.no,.reverse)
  ...
  IF NOT SIG(ei.check.gp[.tool.no]) THEN
    SIGNAL -eo.gp.error[.tool.no]
    RETURN
  END
  TIMER 1 = 0
...
.PROGRAM gripper.open (.gripper.no,.time,.reverse)
  ;
  IF SIG(ei.check.gp[.gripper.no]) AND SIG(gripper.opened[.gripper.no]) THEN
...
.PROGRAM send.plc.pc ()
  ...
  SOUT eo.gp.sensor[1] = gripper.sensor[1]
  SOUT eo.gp.sensor[2] = gripper.sensor[2]
  ;
...
.PROGRAM set.io.pc ()
  ...
  d.cnc1.jaws.ful[0]   = 1377
  d.cnc1.jaws.bod[0]   = 1385
  d.cnc2.jaws.ful[0]   = 1393
  d.cnc2.jaws.bod[0]   = 1401
  ;
  d.plt.rows[0]        = 1409; 4
  d.plt.cell.odd[0]    = 1413; 4
  d.plt.cell.even[0]   = 1417; 4
  d.plt.dx[0]          = 1433
  d.plt.dy[0]          = 1449
...
.PROGRAM state100 () ; Decision making module
  ...
  ;
.END
.PROGRAM state101()@26/02/15 05:14 #382; Decision making module
  ;
...
.PROGRAM state51 () ; Case: st3.tool <> st6.tool; st5.chuck <> st6.chuck
  ...
  IF .sh1 AND .ge AND .ce AND .max.pick
    state = 10
    RETURN
  END
  ;
.END
.PROGRAM state52 () ; Case: st3.tool <> st6.tool; st5.chuck == st6.chuck
  ;
  .shelf.opened = SIG (eo.shelf.opened[current.shelf])
  .shelf.closed = NOT .shelf.opened
  .inside.cnc = SIG (s.inside.cnc)
  ...
  ;
.END
.PROGRAM state53 () ; Case: st3.tool == st6.tool; st5.chuck <> st6.chuck
  ;
  .shelf.opened = SIG (eo.shelf.opened[current.shelf])
  .shelf.closed = NOT .shelf.opened
  .inside.cnc = SIG (s.inside.cnc)
  ...
  ;
.END
.PROGRAM state54 () ; Case: st3.tool == st6.tool; st5.chuck == st6.chuck
  ;
  .shelf.opened = SIG (eo.shelf.opened[current.shelf])
  .shelf.closed = NOT .shelf.opened
  .inside.cnc = SIG (s.inside.cnc)
...
.PROGRAM watchdog.pc ()
  ...
  WHILE TRUE DO
    ...
    IF SIG (di.ext.ereset) THEN
      SIGNAL -eo.gp.error[1]
      SIGNAL -eo.gp.error[2]
      SIGNAL -eo.process.err
    END
    ;
    TWAIT 0.1
...
.END
.TRANS
t.gripper[1] -103.300003 0.000000 104.000000 180.000000 90.000008 -180.000000
t.calib[2] 202.800003 0.000000 104.000000 0.000000 90.000008 -180.000000
t.calib[1] -202.800003 0.000000 104.000000 180.000000 90.000008 -180.000000
...
t.gripper[2] 103.300003 0.000000 104.000000 0.000000 90.000008 -180.000000
t.pin 0.000000 112.000000 104.000000 90.000008 90.000008 0.000000
.END
.JOINTS
